...
ssh-keygen -f '/home/amellado/.ssh/known_hosts' -R $NODO1
ssh-keygen -f '/home/amellado/.ssh/known_hosts' -R $NODO2
ssh-keygen -f '/home/amellado/.ssh/known_hosts' -R $NODO3
